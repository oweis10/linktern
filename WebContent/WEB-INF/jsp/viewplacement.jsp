...
<br/>
<form:form action="http://localhost:8080/Link-Tern/editplacement" method="post" modelAttribute="placement">
	<form:hidden path="id"/>
 	    ...
 	    <div class="row">
 	        ...
 	        <div class="col-md-5">
	            <form:select class="selectpicker form-control" multiple="true" path="objectives">
 	                <option disabled>Select Objectives</option>
 	                <c:forEach items="${selectedObjectives }" var="selectedObjective">
	                	<option selected value="${selectedObjective.getId() }">${selectedObjective.getName()}</option>
	                </c:forEach>
